...
def Label_creator(raw_table_path,Isolates_table_path):
    ...
    drugs = ["trimethoprim/sulfamethoxazole","erythromycin","penicillin","chloramphenicol","tetracycline","cotrimoxazole",
                     "lactam", "clindamycin","linezolid","vancomycin","	cefotaxime","levofloxacin"]
...
if __name__ == "__main__":
    Label_creator("Dataset /label_table.csv", "Dataset /Streptococcus_isolates.csv")
